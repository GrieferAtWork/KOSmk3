 ...
 */
#ifndef GUARD_APPS_WM_RECT_H
#define GUARD_APPS_WM_RECT_H 1
...
INTDEF struct rect KCALL rect_intersect(struct rect a, struct rect b);
...
INTDEF void KCALL rects_insert(struct rects *__restrict self, struct rect r);
INTDEF void KCALL rects_remove(struct rects *__restrict self, struct rect r);
...
INTDEF void KCALL rects_fini(struct rects *__restrict self);


DECL_END

#endif /* !GUARD_APPS_WM_RECT_H */
