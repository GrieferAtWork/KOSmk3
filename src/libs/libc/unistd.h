...
INTDEF int LIBCCALL libc_xmknod(int ver, const char *path, mode_t mode, dev_t *pdev);
INTDEF int LIBCCALL libc_dos_xmknod(int ver, const char *path, mode_t mode, dev_t *pdev);
INTDEF int LIBCCALL libc_xmknodat(int ver, fd_t dfd, const char *path, mode_t mode, dev_t *pdev);
INTDEF int LIBCCALL libc_dos_xmknodat(int ver, fd_t dfd, const char *path, mode_t mode, dev_t *pdev);
...
INTDEF void LIBCCALL libc_Xpipe2(int pipedes[2], int flags);
