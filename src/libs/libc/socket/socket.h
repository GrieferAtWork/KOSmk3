...
INTDEF int LIBCCALL libc_bind(fd_t fd, __CONST_SOCKADDR_ARG addr, socklen_t len);
INTDEF int LIBCCALL libc_getsockname(fd_t fd, __SOCKADDR_ARG addr, socklen_t *__restrict len);
INTDEF int LIBCCALL libc_connect(fd_t fd, __CONST_SOCKADDR_ARG addr, socklen_t len);
INTDEF int LIBCCALL libc_getpeername(fd_t fd, __SOCKADDR_ARG addr, socklen_t *__restrict len);
...
INTDEF ssize_t LIBCCALL libc_sendto(fd_t fd, void const *buf, size_t n, int flags, __CONST_SOCKADDR_ARG addr, socklen_t addr_len);
INTDEF ssize_t LIBCCALL libc_recvfrom(fd_t fd, void *__restrict buf, size_t n, int flags, __SOCKADDR_ARG addr, socklen_t *__restrict addr_len);
...
INTDEF int LIBCCALL libc_accept(fd_t fd, __SOCKADDR_ARG addr, socklen_t *__restrict addr_len);
...
INTDEF int LIBCCALL libc_accept4(fd_t fd, __SOCKADDR_ARG addr, socklen_t *__restrict addr_len, int flags);
