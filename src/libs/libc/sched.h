...
INTDEF int LIBCCALL libc_futex(u32 *uaddr, int futex_op, u32 val, struct timespec32 const *timeout, u32 *uaddr2, u32 val3);
INTDEF int LIBCCALL libc_futex64(u32 *uaddr, int futex_op, u32 val, struct timespec64 const *timeout, u32 *uaddr2, u32 val3);
...
INTDEF pid_t LIBCCALL libc_Xvfork(void);
...
INTDEF int LIBCCALL libc_Xfutex(u32 *uaddr, int futex_op, u32 val, struct timespec32 const *timeout, u32 *uaddr2, u32 val3);
INTDEF int LIBCCALL libc_Xfutex64(u32 *uaddr, int futex_op, u32 val, struct timespec64 const *timeout, u32 *uaddr2, u32 val3);
