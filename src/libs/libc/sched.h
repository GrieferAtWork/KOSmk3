...
INTDEF int LIBCCALL libc_futex(u32 *uaddr, int futex_op, uintptr_t val, struct timespec32 const *timeout, u32 *uaddr2, uintptr_t val3);
INTDEF int LIBCCALL libc_futex64(u32 *uaddr, int futex_op, uintptr_t val, struct timespec64 const *timeout, u32 *uaddr2, uintptr_t val3);
...
INTDEF int LIBCCALL libc_Xfutex(u32 *uaddr, int futex_op, uintptr_t val, struct timespec32 const *timeout, u32 *uaddr2, uintptr_t val3);
INTDEF int LIBCCALL libc_Xfutex64(u32 *uaddr, int futex_op, uintptr_t val, struct timespec64 const *timeout, u32 *uaddr2, uintptr_t val3);
