...
#define __KTYPE(x) __##x,x
#else
#define __KTYPE(x) x
#endif
typedef __INT8_TYPE__   __KTYPE(s8);
typedef __INT16_TYPE__  __KTYPE(s16);
typedef __INT32_TYPE__  __KTYPE(s32);
typedef __INT64_TYPE__  __KTYPE(s64);
typedef __UINT8_TYPE__  __KTYPE(u8);
typedef __UINT16_TYPE__ __KTYPE(u16);
typedef __UINT32_TYPE__ __KTYPE(u32);
typedef __UINT64_TYPE__ __KTYPE(u64);
#undef __KTYPE
...
typedef __UINT64_TYPE__ __KTYPE(le64),__KTYPE(be64);
