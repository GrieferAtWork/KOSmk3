...
#undef __USE_EXCEPT      /* `#ifdef _EXCEPT_SOURCE'  Enable exception support for various C functions (see detailed documentation below). */
 ...
 *        Attempting to use `_DOSFS_SOURCE' with `_EXCEPT_SOURCE' is illegal.
...
#ifdef __USE_DOSFS
#error "Cannot use `_DOSFS_SOURCE' alongside `_EXCEPT_SOURCE'"
#endif
#ifndef __CRT_KOS
#error "Exception supported requires the presense of CRT:KOS"
#endif
#if defined(__DOS_COMPAT__) || defined(__GLC_COMPAT__) || defined(__CYG_COMPAT__)
#error "Cannot build in compatibility mode with `_EXCEPT_SOURCE' enabled"
#endif
#if __KOS_VERSION__ < 300
#error "`_EXCEPT_SOURCE' can only be used starting with KOS Mk3"
#endif
#endif
...
#   define __SYMNAME_DOSDPW32(x)             U_##x
...
#   define __SYMNAME_KOS(x)              KOS$X##x
#   define __SYMNAME_EXCEPT_DOSDPW16(x)      X_##x
#   define __SYMNAME_EXCEPT_DOSDPW32(x)      XU_##x
#   define __SYMNAME_EXCEPT_DOSW16(x)        X##x
#   define __SYMNAME_EXCEPT_DOSW32(x)        XU##x
#   define __SYMNAME_EXCEPT_KOSW16(x)    KOS$Xu##x
#   define __SYMNAME_EXCEPT_KOSW32(x)    KOS$X##x
#   define __SYMNAME_EXCEPT_W16(x)           X##x
#   define __SYMNAME_EXCEPT_W32(x)       KOS$X##x
#   define __SYMNAME_EXCEPT_DOSDP(x)         X_##x
#   define __SYMNAME_EXCEPT_DOS(x)           X##x
#   define __SYMNAME_EXCEPT_KOS(x)       KOS$X##x
#else
...
#   define __SYMNAME_DOSDPW32(x)         DOS$U_##x
...
#   define __SYMNAME_EXCEPT_DOSW16(x)    DOS$X##x
#   define __SYMNAME_EXCEPT_DOSW32(x)    DOS$XU##x
#   define __SYMNAME_EXCEPT_DOSDPW16(x)  DOS$X_##x
#   define __SYMNAME_EXCEPT_DOSDPW32(x)  DOS$XU_##x
#   define __SYMNAME_EXCEPT_KOSW16(x)        Xu##x
#   define __SYMNAME_EXCEPT_KOSW32(x)        X##x
#   define __SYMNAME_EXCEPT_W16(x)       DOS$X##x
#   define __SYMNAME_EXCEPT_W32(x)           X##x
#   define __SYMNAME_EXCEPT_DOSDP(x)     DOS$X_##x
#   define __SYMNAME_EXCEPT_DOS(x)       DOS$X##x
#   define __SYMNAME_EXCEPT_KOS(x)           X##x
#endif
...
#define __REDIRECT_TODOSDPW32(decl,attr,Treturn,cc,name,param,args)                                              __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(name),args)
#define __REDIRECT_TODOSDPW32_(decl,attr,Treturn,cc,name,param,asmname,args)                                     __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(asmname),args)
#define __REDIRECT_TODOSDPW32_VOID(decl,attr,cc,name,param,args)                                                 __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(name),args)
#define __REDIRECT_TODOSDPW32_VOID_(decl,attr,cc,name,param,asmname,args)                                        __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(asmname),args)
#define __REDIRECT_TODOSDPW32_NOTHROW(decl,attr,Treturn,cc,name,param,args)                                      __REDIRECT_NOTHROW(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(name),args)
#define __REDIRECT_TODOSDPW32_NOTHROW_(decl,attr,Treturn,cc,name,param,asmname,args)                             __REDIRECT_NOTHROW(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(asmname),args)
#define __REDIRECT_TODOSDPW32_VOID_NOTHROW(decl,attr,cc,name,param,args)                                         __REDIRECT_VOID_NOTHROW(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(name),args)
#define __REDIRECT_TODOSDPW32_VOID_NOTHROW_(decl,attr,cc,name,param,asmname,args)                                __REDIRECT_VOID_NOTHROW(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(asmname),args)
#define __VREDIRECT_TODOSDPW32(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                   __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(name),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)         __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(asmnamef),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                      __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(name),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)            __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(asmnamef),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_NOTHROW(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)           __VREDIRECT_NOTHROW(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(name),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_NOTHROW_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start) __VREDIRECT_NOTHROW(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(asmnamef),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_VOID_NOTHROW(decl,attr,cc,name,param,vasmnamef,args,before_va_start)              __VREDIRECT_VOID_NOTHROW(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(name),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_TODOSDPW32_VOID_NOTHROW_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)    __VREDIRECT_VOID_NOTHROW(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(asmnamef),__SYMNAME_DOSDPW32(vasmnamef),args,before_va_start)
#define __XREDIRECT_TODOSDPW32(decl,attr,Treturn,cc,name,param,code)                                             __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(name),code)
#define __XREDIRECT_TODOSDPW32_(decl,attr,Treturn,cc,name,param,asmname,code)                                    __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(asmname),code)
#define __XREDIRECT_TODOSDPW32_VOID(decl,attr,cc,name,param,code)                                                __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(name),code)
#define __XREDIRECT_TODOSDPW32_VOID_(decl,attr,cc,name,param,asmname,code)                                       __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(asmname),code)
#define __XREDIRECT_TODOSDPW32_NOTHROW(decl,attr,Treturn,cc,name,param,code)                                     __XREDIRECT_NOTHROW(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(name),code)
#define __XREDIRECT_TODOSDPW32_NOTHROW_(decl,attr,Treturn,cc,name,param,asmname,code)                            __XREDIRECT_NOTHROW(decl,attr,Treturn,cc,name,param,__SYMNAME_DOSDPW32(asmname),code)
#define __XREDIRECT_TODOSDPW32_VOID_NOTHROW(decl,attr,cc,name,param,code)                                        __XREDIRECT_VOID_NOTHROW(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(name),code)
#define __XREDIRECT_TODOSDPW32_VOID_NOTHROW_(decl,attr,cc,name,param,asmname,code)                               __XREDIRECT_VOID_NOTHROW(decl,attr,cc,name,param,__SYMNAME_DOSDPW32(asmname),code)
...
#define __REDIRECT_EXCEPT_TODOSW16(decl,attr,Treturn,cc,name,param,args)                                                      __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),args)
#define __REDIRECT_EXCEPT_TODOSW16_(decl,attr,Treturn,cc,name,param,asmname,args)                                             __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmname),args)
#define __REDIRECT_EXCEPT_TODOSW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,args)                                        __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),args)
#define __REDIRECT_EXCEPT_TODOSW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,args)                               __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmname),args)
#define __REDIRECT_EXCEPT_TODOSW16_VOID(decl,attr,cc,name,param,args)                                                         __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),args)
#define __REDIRECT_EXCEPT_TODOSW16_VOID_(decl,attr,cc,name,param,asmname,args)                                                __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmname),args)
#define __VREDIRECT_EXCEPT_TODOSW16(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                           __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),__SYMNAME_EXCEPT_DOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW16_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                 __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmnamef),__SYMNAME_EXCEPT_DOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,vasmnamef,args,before_va_start)             __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),__SYMNAME_EXCEPT_DOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmnamef,vasmnamef,args,before_va_start)   __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmnamef),__SYMNAME_EXCEPT_DOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW16_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                              __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),__SYMNAME_EXCEPT_DOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW16_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                    __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmnamef),__SYMNAME_EXCEPT_DOSW16(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_TODOSW16(decl,attr,Treturn,cc,name,param,code)                                                     __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),code)
#define __XREDIRECT_EXCEPT_TODOSW16_(decl,attr,Treturn,cc,name,param,asmname,code)                                            __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,code)                                       __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),code)
#define __XREDIRECT_EXCEPT_TODOSW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,code)                              __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSW16_VOID(decl,attr,cc,name,param,code)                                                        __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(name),code)
#define __XREDIRECT_EXCEPT_TODOSW16_VOID_(decl,attr,cc,name,param,asmname,code)                                               __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW16(asmname),code)
#define __REDIRECT_EXCEPT_TODOSW32(decl,attr,Treturn,cc,name,param,args)                                                      __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),args)
#define __REDIRECT_EXCEPT_TODOSW32_(decl,attr,Treturn,cc,name,param,asmname,args)                                             __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmname),args)
#define __REDIRECT_EXCEPT_TODOSW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,args)                                        __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),args)
#define __REDIRECT_EXCEPT_TODOSW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,args)                               __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmname),args)
#define __REDIRECT_EXCEPT_TODOSW32_VOID(decl,attr,cc,name,param,args)                                                         __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),args)
#define __REDIRECT_EXCEPT_TODOSW32_VOID_(decl,attr,cc,name,param,asmname,args)                                                __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmname),args)
#define __VREDIRECT_EXCEPT_TODOSW32(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                           __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),__SYMNAME_EXCEPT_DOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW32_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                 __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmnamef),__SYMNAME_EXCEPT_DOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,vasmnamef,args,before_va_start)             __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),__SYMNAME_EXCEPT_DOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmnamef,vasmnamef,args,before_va_start)   __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmnamef),__SYMNAME_EXCEPT_DOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW32_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                              __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),__SYMNAME_EXCEPT_DOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSW32_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                    __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmnamef),__SYMNAME_EXCEPT_DOSW32(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_TODOSW32(decl,attr,Treturn,cc,name,param,code)                                                     __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),code)
#define __XREDIRECT_EXCEPT_TODOSW32_(decl,attr,Treturn,cc,name,param,asmname,code)                                            __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,code)                                       __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),code)
#define __XREDIRECT_EXCEPT_TODOSW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,code)                              __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSW32_VOID(decl,attr,cc,name,param,code)                                                        __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(name),code)
#define __XREDIRECT_EXCEPT_TODOSW32_VOID_(decl,attr,cc,name,param,asmname,code)                                               __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSW32(asmname),code)
#define __REDIRECT_EXCEPT_TODOSDPW16(decl,attr,Treturn,cc,name,param,args)                                                    __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),args)
#define __REDIRECT_EXCEPT_TODOSDPW16_(decl,attr,Treturn,cc,name,param,asmname,args)                                           __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmname),args)
#define __REDIRECT_EXCEPT_TODOSDPW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,args)                                      __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),args)
#define __REDIRECT_EXCEPT_TODOSDPW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,args)                             __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmname),args)
#define __REDIRECT_EXCEPT_TODOSDPW16_VOID(decl,attr,cc,name,param,args)                                                       __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),args)
#define __REDIRECT_EXCEPT_TODOSDPW16_VOID_(decl,attr,cc,name,param,asmname,args)                                              __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmname),args)
#define __VREDIRECT_EXCEPT_TODOSDPW16(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                         __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),__SYMNAME_EXCEPT_DOSDPW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW16_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)               __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmnamef),__SYMNAME_EXCEPT_DOSDPW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,vasmnamef,args,before_va_start)           __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),__SYMNAME_EXCEPT_DOSDPW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmnamef,vasmnamef,args,before_va_start) __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmnamef),__SYMNAME_EXCEPT_DOSDPW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW16_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                            __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),__SYMNAME_EXCEPT_DOSDPW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW16_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                  __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmnamef),__SYMNAME_EXCEPT_DOSDPW16(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_TODOSDPW16(decl,attr,Treturn,cc,name,param,code)                                                   __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),code)
#define __XREDIRECT_EXCEPT_TODOSDPW16_(decl,attr,Treturn,cc,name,param,asmname,code)                                          __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSDPW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,code)                                     __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),code)
#define __XREDIRECT_EXCEPT_TODOSDPW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,code)                            __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSDPW16_VOID(decl,attr,cc,name,param,code)                                                      __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(name),code)
#define __XREDIRECT_EXCEPT_TODOSDPW16_VOID_(decl,attr,cc,name,param,asmname,code)                                             __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW16(asmname),code)
#define __REDIRECT_EXCEPT_TODOSDPW32(decl,attr,Treturn,cc,name,param,args)                                                    __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),args)
#define __REDIRECT_EXCEPT_TODOSDPW32_(decl,attr,Treturn,cc,name,param,asmname,args)                                           __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmname),args)
#define __REDIRECT_EXCEPT_TODOSDPW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,args)                                      __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),args)
#define __REDIRECT_EXCEPT_TODOSDPW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,args)                             __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmname),args)
#define __REDIRECT_EXCEPT_TODOSDPW32_VOID(decl,attr,cc,name,param,args)                                                       __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),args)
#define __REDIRECT_EXCEPT_TODOSDPW32_VOID_(decl,attr,cc,name,param,asmname,args)                                              __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmname),args)
#define __VREDIRECT_EXCEPT_TODOSDPW32(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                         __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),__SYMNAME_EXCEPT_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW32_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)               __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmnamef),__SYMNAME_EXCEPT_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,vasmnamef,args,before_va_start)           __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),__SYMNAME_EXCEPT_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmnamef,vasmnamef,args,before_va_start) __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmnamef),__SYMNAME_EXCEPT_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW32_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                            __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),__SYMNAME_EXCEPT_DOSDPW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TODOSDPW32_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                  __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmnamef),__SYMNAME_EXCEPT_DOSDPW32(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_TODOSDPW32(decl,attr,Treturn,cc,name,param,code)                                                   __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),code)
#define __XREDIRECT_EXCEPT_TODOSDPW32_(decl,attr,Treturn,cc,name,param,asmname,code)                                          __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSDPW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,code)                                     __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),code)
#define __XREDIRECT_EXCEPT_TODOSDPW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,code)                            __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmname),code)
#define __XREDIRECT_EXCEPT_TODOSDPW32_VOID(decl,attr,cc,name,param,code)                                                      __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(name),code)
#define __XREDIRECT_EXCEPT_TODOSDPW32_VOID_(decl,attr,cc,name,param,asmname,code)                                             __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_DOSDPW32(asmname),code)
#define __REDIRECT_EXCEPT_TOKOSW16(decl,attr,Treturn,cc,name,param,args)                                                      __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),args)
#define __REDIRECT_EXCEPT_TOKOSW16_(decl,attr,Treturn,cc,name,param,asmname,args)                                             __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmname),args)
#define __REDIRECT_EXCEPT_TOKOSW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,args)                                        __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),args)
#define __REDIRECT_EXCEPT_TOKOSW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,args)                               __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmname),args)
#define __REDIRECT_EXCEPT_TOKOSW16_VOID(decl,attr,cc,name,param,args)                                                         __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),args)
#define __REDIRECT_EXCEPT_TOKOSW16_VOID_(decl,attr,cc,name,param,asmname,args)                                                __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmname),args)
#define __VREDIRECT_EXCEPT_TOKOSW16(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                           __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),__SYMNAME_EXCEPT_KOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW16_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                 __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmnamef),__SYMNAME_EXCEPT_KOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,vasmnamef,args,before_va_start)             __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),__SYMNAME_EXCEPT_KOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmnamef,vasmnamef,args,before_va_start)   __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmnamef),__SYMNAME_EXCEPT_KOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW16_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                              __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),__SYMNAME_EXCEPT_KOSW16(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW16_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                    __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmnamef),__SYMNAME_EXCEPT_KOSW16(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_TOKOSW16(decl,attr,Treturn,cc,name,param,code)                                                     __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),code)
#define __XREDIRECT_EXCEPT_TOKOSW16_(decl,attr,Treturn,cc,name,param,asmname,code)                                            __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmname),code)
#define __XREDIRECT_EXCEPT_TOKOSW16_XVOID(decl,attr,Treturn_nexcept,cc,name,param,code)                                       __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),code)
#define __XREDIRECT_EXCEPT_TOKOSW16_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,code)                              __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmname),code)
#define __XREDIRECT_EXCEPT_TOKOSW16_VOID(decl,attr,cc,name,param,code)                                                        __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(name),code)
#define __XREDIRECT_EXCEPT_TOKOSW16_VOID_(decl,attr,cc,name,param,asmname,code)                                               __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW16(asmname),code)
#define __REDIRECT_EXCEPT_TOKOSW32(decl,attr,Treturn,cc,name,param,args)                                                      __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),args)
#define __REDIRECT_EXCEPT_TOKOSW32_(decl,attr,Treturn,cc,name,param,asmname,args)                                             __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmname),args)
#define __REDIRECT_EXCEPT_TOKOSW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,args)                                        __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),args)
#define __REDIRECT_EXCEPT_TOKOSW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,args)                               __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmname),args)
#define __REDIRECT_EXCEPT_TOKOSW32_VOID(decl,attr,cc,name,param,args)                                                         __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),args)
#define __REDIRECT_EXCEPT_TOKOSW32_VOID_(decl,attr,cc,name,param,asmname,args)                                                __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmname),args)
#define __VREDIRECT_EXCEPT_TOKOSW32(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)                           __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),__SYMNAME_EXCEPT_KOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW32_(decl,attr,Treturn,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                 __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmnamef),__SYMNAME_EXCEPT_KOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,vasmnamef,args,before_va_start)             __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),__SYMNAME_EXCEPT_KOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmnamef,vasmnamef,args,before_va_start)   __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmnamef),__SYMNAME_EXCEPT_KOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW32_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)                              __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),__SYMNAME_EXCEPT_KOSW32(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_TOKOSW32_VOID_(decl,attr,cc,name,param,asmnamef,vasmnamef,args,before_va_start)                    __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmnamef),__SYMNAME_EXCEPT_KOSW32(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_TOKOSW32(decl,attr,Treturn,cc,name,param,code)                                                     __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),code)
#define __XREDIRECT_EXCEPT_TOKOSW32_(decl,attr,Treturn,cc,name,param,asmname,code)                                            __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmname),code)
#define __XREDIRECT_EXCEPT_TOKOSW32_XVOID(decl,attr,Treturn_nexcept,cc,name,param,code)                                       __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),code)
#define __XREDIRECT_EXCEPT_TOKOSW32_XVOID_(decl,attr,Treturn_nexcept,cc,name,param,asmname,code)                              __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmname),code)
#define __XREDIRECT_EXCEPT_TOKOSW32_VOID(decl,attr,cc,name,param,code)                                                        __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(name),code)
#define __XREDIRECT_EXCEPT_TOKOSW32_VOID_(decl,attr,cc,name,param,asmname,code)                                               __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOSW32(asmname),code)
#define __REDIRECT_EXCEPT_TOKOS                                                                                               __REDIRECT_EXCEPT_TOKOSW32
#define __REDIRECT_EXCEPT_TODOS                                                                                               __REDIRECT_EXCEPT_TODOSW16
#define __REDIRECT_EXCEPT_TOKOS_                                                                                              __REDIRECT_EXCEPT_TOKOSW32_
#define __REDIRECT_EXCEPT_TODOS_                                                                                              __REDIRECT_EXCEPT_TODOSW16_
#define __REDIRECT_EXCEPT_TOKOS_XVOID                                                                                         __REDIRECT_EXCEPT_TOKOSW32_XVOID
#define __REDIRECT_EXCEPT_TODOS_XVOID                                                                                         __REDIRECT_EXCEPT_TODOSW16_XVOID
#define __REDIRECT_EXCEPT_TOKOS_XVOID_                                                                                        __REDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __REDIRECT_EXCEPT_TODOS_XVOID_                                                                                        __REDIRECT_EXCEPT_TODOSW16_XVOID_
#define __REDIRECT_EXCEPT_TOKOS_VOID                                                                                          __REDIRECT_EXCEPT_TOKOSW32_VOID
#define __REDIRECT_EXCEPT_TODOS_VOID                                                                                          __REDIRECT_EXCEPT_TODOSW16_VOID
#define __REDIRECT_EXCEPT_TOKOS_VOID_                                                                                         __REDIRECT_EXCEPT_TOKOSW32_VOID_
#define __REDIRECT_EXCEPT_TODOS_VOID_                                                                                         __REDIRECT_EXCEPT_TODOSW16_VOID_
#define __VREDIRECT_EXCEPT_TOKOS                                                                                              __VREDIRECT_EXCEPT_TOKOSW32
#define __VREDIRECT_EXCEPT_TODOS                                                                                              __VREDIRECT_EXCEPT_TODOSW16
#define __VREDIRECT_EXCEPT_TOKOS_                                                                                             __VREDIRECT_EXCEPT_TOKOSW32_
#define __VREDIRECT_EXCEPT_TODOS_                                                                                             __VREDIRECT_EXCEPT_TODOSW16_
#define __VREDIRECT_EXCEPT_TOKOS_XVOID                                                                                        __VREDIRECT_EXCEPT_TOKOSW32_XVOID
#define __VREDIRECT_EXCEPT_TODOS_XVOID                                                                                        __VREDIRECT_EXCEPT_TODOSW16_XVOID
#define __VREDIRECT_EXCEPT_TOKOS_XVOID_                                                                                       __VREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __VREDIRECT_EXCEPT_TODOS_XVOID_                                                                                       __VREDIRECT_EXCEPT_TODOSW16_XVOID_
#define __VREDIRECT_EXCEPT_TOKOS_VOID                                                                                         __VREDIRECT_EXCEPT_TOKOSW32_VOID
#define __VREDIRECT_EXCEPT_TODOS_VOID                                                                                         __VREDIRECT_EXCEPT_TODOSW16_VOID
#define __VREDIRECT_EXCEPT_TOKOS_VOID_                                                                                        __VREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __VREDIRECT_EXCEPT_TODOS_VOID_                                                                                        __VREDIRECT_EXCEPT_TODOSW16_VOID_
#define __XREDIRECT_EXCEPT_TOKOS                                                                                              __XREDIRECT_EXCEPT_TOKOSW32
#define __XREDIRECT_EXCEPT_TODOS                                                                                              __XREDIRECT_EXCEPT_TODOSW16
#define __XREDIRECT_EXCEPT_TOKOS_                                                                                             __XREDIRECT_EXCEPT_TOKOSW32_
#define __XREDIRECT_EXCEPT_TODOS_                                                                                             __XREDIRECT_EXCEPT_TODOSW16_
#define __XREDIRECT_EXCEPT_TOKOS_XVOID                                                                                        __XREDIRECT_EXCEPT_TOKOSW32_XVOID
#define __XREDIRECT_EXCEPT_TODOS_XVOID                                                                                        __XREDIRECT_EXCEPT_TODOSW16_XVOID
#define __XREDIRECT_EXCEPT_TOKOS_XVOID_                                                                                       __XREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __XREDIRECT_EXCEPT_TODOS_XVOID_                                                                                       __XREDIRECT_EXCEPT_TODOSW16_XVOID_
#define __XREDIRECT_EXCEPT_TOKOS_VOID                                                                                         __XREDIRECT_EXCEPT_TOKOSW32_VOID
#define __XREDIRECT_EXCEPT_TODOS_VOID                                                                                         __XREDIRECT_EXCEPT_TODOSW16_VOID
#define __XREDIRECT_EXCEPT_TOKOS_VOID_                                                                                        __XREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __XREDIRECT_EXCEPT_TODOS_VOID_                                                                                        __XREDIRECT_EXCEPT_TODOSW16_VOID_
#define __REDIRECT_EXCEPT_W16                                                                                                 __REDIRECT_EXCEPT_TODOSW16_
#define __REDIRECT_EXCEPT_W32                                                                                                 __REDIRECT_EXCEPT_TOKOSW32_
#define __REDIRECT_EXCEPT_W16_XVOID                                                                                           __REDIRECT_EXCEPT_TODOSW16_XVOID_
#define __REDIRECT_EXCEPT_W32_XVOID                                                                                           __REDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __REDIRECT_EXCEPT_W16_VOID                                                                                            __REDIRECT_EXCEPT_TODOSW16_VOID_
#define __REDIRECT_EXCEPT_W32_VOID                                                                                            __REDIRECT_EXCEPT_TOKOSW32_VOID_
#define __VREDIRECT_EXCEPT_W16                                                                                                __VREDIRECT_EXCEPT_TODOSW16_
#define __VREDIRECT_EXCEPT_W32                                                                                                __VREDIRECT_EXCEPT_TOKOSW32_
#define __VREDIRECT_EXCEPT_W16_XVOID                                                                                          __VREDIRECT_EXCEPT_TODOSW16_XVOID_
#define __VREDIRECT_EXCEPT_W32_XVOID                                                                                          __VREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __VREDIRECT_EXCEPT_W16_VOID                                                                                           __VREDIRECT_EXCEPT_TODOSW16_VOID_
#define __VREDIRECT_EXCEPT_W32_VOID                                                                                           __VREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __XREDIRECT_EXCEPT_W16                                                                                                __XREDIRECT_EXCEPT_TODOSW16_
#define __XREDIRECT_EXCEPT_W32                                                                                                __XREDIRECT_EXCEPT_TOKOSW32_
#define __XREDIRECT_EXCEPT_W16_XVOID                                                                                          __XREDIRECT_EXCEPT_TODOSW16_XVOID_
#define __XREDIRECT_EXCEPT_W32_XVOID                                                                                          __XREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __XREDIRECT_EXCEPT_W16_VOID                                                                                           __XREDIRECT_EXCEPT_TODOSW16_VOID_
#define __XREDIRECT_EXCEPT_W32_VOID                                                                                           __XREDIRECT_EXCEPT_TOKOSW32_VOID_
#ifdef __DOS_COMPAT__
#define __REDIRECT_EXCEPT           __REDIRECT_EXCEPT_TODOS
#define __REDIRECT_EXCEPT_          __REDIRECT_EXCEPT_TODOS_
#define __REDIRECT_EXCEPT_XVOID     __REDIRECT_EXCEPT_TODOS_XVOID
#define __REDIRECT_EXCEPT_XVOID_    __REDIRECT_EXCEPT_TODOS_XVOID_
#define __REDIRECT_EXCEPT_VOID      __REDIRECT_EXCEPT_TODOS_VOID
#define __REDIRECT_EXCEPT_VOID_     __REDIRECT_EXCEPT_TODOS_VOID_
#define __VREDIRECT_EXCEPT          __VREDIRECT_EXCEPT_TODOS
#define __VREDIRECT_EXCEPT_         __VREDIRECT_EXCEPT_TODOS_
#define __VREDIRECT_EXCEPT_XVOID    __VREDIRECT_EXCEPT_TODOS_XVOID
#define __VREDIRECT_EXCEPT_XVOID_   __VREDIRECT_EXCEPT_TODOS_XVOID_
#define __VREDIRECT_EXCEPT_VOID     __VREDIRECT_EXCEPT_TODOS_VOID
#define __VREDIRECT_EXCEPT_VOID_    __VREDIRECT_EXCEPT_TODOS_VOID_
#define __XREDIRECT_EXCEPT          __XREDIRECT_EXCEPT_TODOS
#define __XREDIRECT_EXCEPT_         __XREDIRECT_EXCEPT_TODOS_
#define __XREDIRECT_EXCEPT_XVOID    __XREDIRECT_EXCEPT_TODOS_XVOID
#define __XREDIRECT_EXCEPT_XVOID_   __XREDIRECT_EXCEPT_TODOS_XVOID_
#define __XREDIRECT_EXCEPT_VOID     __XREDIRECT_EXCEPT_TODOS_VOID
#define __XREDIRECT_EXCEPT_VOID_    __XREDIRECT_EXCEPT_TODOS_VOID_
#else /* __DOS_COMPAT__ */
#define __REDIRECT_EXCEPT           __REDIRECT_EXCEPT_TOKOS
#define __REDIRECT_EXCEPT_          __REDIRECT_EXCEPT_TOKOS_
#define __REDIRECT_EXCEPT_XVOID     __REDIRECT_EXCEPT_TOKOS_XVOID
#define __REDIRECT_EXCEPT_XVOID_    __REDIRECT_EXCEPT_TOKOS_XVOID_
#define __REDIRECT_EXCEPT_VOID      __REDIRECT_EXCEPT_TOKOS_VOID
#define __REDIRECT_EXCEPT_VOID_     __REDIRECT_EXCEPT_TOKOS_VOID_
#define __VREDIRECT_EXCEPT          __VREDIRECT_EXCEPT_TOKOS
#define __VREDIRECT_EXCEPT_         __VREDIRECT_EXCEPT_TOKOS_
#define __VREDIRECT_EXCEPT_XVOID    __VREDIRECT_EXCEPT_TOKOS_XVOID
#define __VREDIRECT_EXCEPT_XVOID_   __VREDIRECT_EXCEPT_TOKOS_XVOID_
#define __VREDIRECT_EXCEPT_VOID     __VREDIRECT_EXCEPT_TOKOS_VOID
#define __VREDIRECT_EXCEPT_VOID_    __VREDIRECT_EXCEPT_TOKOS_VOID_
#define __XREDIRECT_EXCEPT          __XREDIRECT_EXCEPT_TOKOS
#define __XREDIRECT_EXCEPT_         __XREDIRECT_EXCEPT_TOKOS_
#define __XREDIRECT_EXCEPT_XVOID    __XREDIRECT_EXCEPT_TOKOS_XVOID
#define __XREDIRECT_EXCEPT_XVOID_   __XREDIRECT_EXCEPT_TOKOS_XVOID_
#define __XREDIRECT_EXCEPT_VOID     __XREDIRECT_EXCEPT_TOKOS_VOID
#define __XREDIRECT_EXCEPT_VOID_    __XREDIRECT_EXCEPT_TOKOS_VOID_
#endif /* !__DOS_COMPAT__ */
#define __XATTR_RETNONNULL          __ATTR_RETNONNULL
#else /* __USE_EXCEPT */
#define __IF_USE_EXCEPT(x)      /* nothing */
#define __IF_NUSE_EXCEPT(x)     x
#define __EXCEPT_SELECT(tt,ff)  ff
#define __REDIRECT_EXCEPT_TODOSW16           __REDIRECT_TODOSW16
#define __REDIRECT_EXCEPT_TODOSW16_          __REDIRECT_TODOSW16_
#define __REDIRECT_EXCEPT_TODOSW16_XVOID     __REDIRECT_TODOSW16
#define __REDIRECT_EXCEPT_TODOSW16_XVOID_    __REDIRECT_TODOSW16_
#define __REDIRECT_EXCEPT_TODOSW16_VOID      __REDIRECT_TODOSW16_VOID
#define __REDIRECT_EXCEPT_TODOSW16_VOID_     __REDIRECT_TODOSW16_VOID_
#define __VREDIRECT_EXCEPT_TODOSW16          __VREDIRECT_TODOSW16
#define __VREDIRECT_EXCEPT_TODOSW16_         __VREDIRECT_TODOSW16_
#define __VREDIRECT_EXCEPT_TODOSW16_XVOID    __VREDIRECT_TODOSW16
#define __VREDIRECT_EXCEPT_TODOSW16_XVOID_   __VREDIRECT_TODOSW16_
#define __VREDIRECT_EXCEPT_TODOSW16_VOID     __VREDIRECT_TODOSW16_VOID
#define __VREDIRECT_EXCEPT_TODOSW16_VOID_    __VREDIRECT_TODOSW16_VOID_
#define __XREDIRECT_EXCEPT_TODOSW16          __XREDIRECT_TODOSW16
#define __XREDIRECT_EXCEPT_TODOSW16_         __XREDIRECT_TODOSW16_
#define __XREDIRECT_EXCEPT_TODOSW16_XVOID    __XREDIRECT_TODOSW16
#define __XREDIRECT_EXCEPT_TODOSW16_XVOID_   __XREDIRECT_TODOSW16_
#define __XREDIRECT_EXCEPT_TODOSW16_VOID     __XREDIRECT_TODOSW16_VOID
#define __XREDIRECT_EXCEPT_TODOSW16_VOID_    __XREDIRECT_TODOSW16_VOID_
#define __REDIRECT_EXCEPT_TODOSW32           __REDIRECT_TODOSW32
#define __REDIRECT_EXCEPT_TODOSW32_          __REDIRECT_TODOSW32_
#define __REDIRECT_EXCEPT_TODOSW32_XVOID     __REDIRECT_TODOSW32
#define __REDIRECT_EXCEPT_TODOSW32_XVOID_    __REDIRECT_TODOSW32_
#define __REDIRECT_EXCEPT_TODOSW32_VOID      __REDIRECT_TODOSW32_VOID
#define __REDIRECT_EXCEPT_TODOSW32_VOID_     __REDIRECT_TODOSW32_VOID_
#define __VREDIRECT_EXCEPT_TODOSW32          __VREDIRECT_TODOSW32
#define __VREDIRECT_EXCEPT_TODOSW32_         __VREDIRECT_TODOSW32_
#define __VREDIRECT_EXCEPT_TODOSW32_XVOID    __VREDIRECT_TODOSW32
#define __VREDIRECT_EXCEPT_TODOSW32_XVOID_   __VREDIRECT_TODOSW32_
#define __VREDIRECT_EXCEPT_TODOSW32_VOID     __VREDIRECT_TODOSW32_VOID
#define __VREDIRECT_EXCEPT_TODOSW32_VOID_    __VREDIRECT_TODOSW32_VOID_
#define __XREDIRECT_EXCEPT_TODOSW32          __XREDIRECT_TODOSW32
#define __XREDIRECT_EXCEPT_TODOSW32_         __XREDIRECT_TODOSW32_
#define __XREDIRECT_EXCEPT_TODOSW32_XVOID    __XREDIRECT_TODOSW32
#define __XREDIRECT_EXCEPT_TODOSW32_XVOID_   __XREDIRECT_TODOSW32_
#define __XREDIRECT_EXCEPT_TODOSW32_VOID     __XREDIRECT_TODOSW32_VOID
#define __XREDIRECT_EXCEPT_TODOSW32_VOID_    __XREDIRECT_TODOSW32_VOID_
#define __REDIRECT_EXCEPT_TODOSDPW16         __REDIRECT_TODOSDPW16
#define __REDIRECT_EXCEPT_TODOSDPW16_        __REDIRECT_TODOSDPW16_
#define __REDIRECT_EXCEPT_TODOSDPW16_XVOID   __REDIRECT_TODOSDPW16
#define __REDIRECT_EXCEPT_TODOSDPW16_XVOID_  __REDIRECT_TODOSDPW16_
#define __REDIRECT_EXCEPT_TODOSDPW16_VOID    __REDIRECT_TODOSDPW16_VOID
#define __REDIRECT_EXCEPT_TODOSDPW16_VOID_   __REDIRECT_TODOSDPW16_VOID_
#define __VREDIRECT_EXCEPT_TODOSDPW16        __VREDIRECT_TODOSDPW16
#define __VREDIRECT_EXCEPT_TODOSDPW16_       __VREDIRECT_TODOSDPW16_
#define __VREDIRECT_EXCEPT_TODOSDPW16_XVOID  __VREDIRECT_TODOSDPW16
#define __VREDIRECT_EXCEPT_TODOSDPW16_XVOID_ __VREDIRECT_TODOSDPW16_
#define __VREDIRECT_EXCEPT_TODOSDPW16_VOID   __VREDIRECT_TODOSDPW16_VOID
#define __VREDIRECT_EXCEPT_TODOSDPW16_VOID_  __VREDIRECT_TODOSDPW16_VOID_
#define __XREDIRECT_EXCEPT_TODOSDPW16        __XREDIRECT_TODOSDPW16
#define __XREDIRECT_EXCEPT_TODOSDPW16_       __XREDIRECT_TODOSDPW16_
#define __XREDIRECT_EXCEPT_TODOSDPW16_XVOID  __XREDIRECT_TODOSDPW16
#define __XREDIRECT_EXCEPT_TODOSDPW16_XVOID_ __XREDIRECT_TODOSDPW16_
#define __XREDIRECT_EXCEPT_TODOSDPW16_VOID   __XREDIRECT_TODOSDPW16_VOID
#define __XREDIRECT_EXCEPT_TODOSDPW16_VOID_  __XREDIRECT_TODOSDPW16_VOID_
#define __REDIRECT_EXCEPT_TODOSDPW32         __REDIRECT_TODOSDPW32
#define __REDIRECT_EXCEPT_TODOSDPW32_        __REDIRECT_TODOSDPW32_
#define __REDIRECT_EXCEPT_TODOSDPW32_XVOID   __REDIRECT_TODOSDPW32
#define __REDIRECT_EXCEPT_TODOSDPW32_XVOID_  __REDIRECT_TODOSDPW32_
#define __REDIRECT_EXCEPT_TODOSDPW32_VOID    __REDIRECT_TODOSDPW32_VOID
#define __REDIRECT_EXCEPT_TODOSDPW32_VOID_   __REDIRECT_TODOSDPW32_VOID_
#define __VREDIRECT_EXCEPT_TODOSDPW32        __VREDIRECT_TODOSDPW32
#define __VREDIRECT_EXCEPT_TODOSDPW32_       __VREDIRECT_TODOSDPW32_
#define __VREDIRECT_EXCEPT_TODOSDPW32_XVOID  __VREDIRECT_TODOSDPW32
#define __VREDIRECT_EXCEPT_TODOSDPW32_XVOID_ __VREDIRECT_TODOSDPW32_
#define __VREDIRECT_EXCEPT_TODOSDPW32_VOID   __VREDIRECT_TODOSDPW32_VOID
#define __VREDIRECT_EXCEPT_TODOSDPW32_VOID_  __VREDIRECT_TODOSDPW32_VOID_
#define __XREDIRECT_EXCEPT_TODOSDPW32        __XREDIRECT_TODOSDPW32
#define __XREDIRECT_EXCEPT_TODOSDPW32_       __XREDIRECT_TODOSDPW32_
#define __XREDIRECT_EXCEPT_TODOSDPW32_XVOID  __XREDIRECT_TODOSDPW32
#define __XREDIRECT_EXCEPT_TODOSDPW32_XVOID_ __XREDIRECT_TODOSDPW32_
#define __XREDIRECT_EXCEPT_TODOSDPW32_VOID   __XREDIRECT_TODOSDPW32_VOID
#define __XREDIRECT_EXCEPT_TODOSDPW32_VOID_  __XREDIRECT_TODOSDPW32_VOID_
#define __REDIRECT_EXCEPT_TOKOSW16           __REDIRECT_TOKOSW16
#define __REDIRECT_EXCEPT_TOKOSW16_          __REDIRECT_TOKOSW16_
#define __REDIRECT_EXCEPT_TOKOSW16_XVOID     __REDIRECT_TOKOSW16
#define __REDIRECT_EXCEPT_TOKOSW16_XVOID_    __REDIRECT_TOKOSW16_
#define __REDIRECT_EXCEPT_TOKOSW16_VOID      __REDIRECT_TOKOSW16_VOID
#define __REDIRECT_EXCEPT_TOKOSW16_VOID_     __REDIRECT_TOKOSW16_VOID_
#define __VREDIRECT_EXCEPT_TOKOSW16          __VREDIRECT_TOKOSW16
#define __VREDIRECT_EXCEPT_TOKOSW16_         __VREDIRECT_TOKOSW16_
#define __VREDIRECT_EXCEPT_TOKOSW16_XVOID    __VREDIRECT_TOKOSW16
#define __VREDIRECT_EXCEPT_TOKOSW16_XVOID_   __VREDIRECT_TOKOSW16_
#define __VREDIRECT_EXCEPT_TOKOSW16_VOID     __VREDIRECT_TOKOSW16_VOID
#define __VREDIRECT_EXCEPT_TOKOSW16_VOID_    __VREDIRECT_TOKOSW16_VOID_
#define __XREDIRECT_EXCEPT_TOKOSW16          __XREDIRECT_TOKOSW16
#define __XREDIRECT_EXCEPT_TOKOSW16_         __XREDIRECT_TOKOSW16_
#define __XREDIRECT_EXCEPT_TOKOSW16_XVOID    __XREDIRECT_TOKOSW16
#define __XREDIRECT_EXCEPT_TOKOSW16_XVOID_   __XREDIRECT_TOKOSW16_
#define __XREDIRECT_EXCEPT_TOKOSW16_VOID     __XREDIRECT_TOKOSW16_VOID
#define __XREDIRECT_EXCEPT_TOKOSW16_VOID_    __XREDIRECT_TOKOSW16_VOID_
#define __REDIRECT_EXCEPT_TOKOSW32           __REDIRECT_TOKOSW32
#define __REDIRECT_EXCEPT_TOKOSW32_          __REDIRECT_TOKOSW32_
#define __REDIRECT_EXCEPT_TOKOSW32_XVOID     __REDIRECT_TOKOSW32
#define __REDIRECT_EXCEPT_TOKOSW32_XVOID_    __REDIRECT_TOKOSW32_
#define __REDIRECT_EXCEPT_TOKOSW32_VOID      __REDIRECT_TOKOSW32_VOID
#define __REDIRECT_EXCEPT_TOKOSW32_VOID_     __REDIRECT_TOKOSW32_VOID_
#define __VREDIRECT_EXCEPT_TOKOSW32          __VREDIRECT_TOKOSW32
#define __VREDIRECT_EXCEPT_TOKOSW32_         __VREDIRECT_TOKOSW32_
#define __VREDIRECT_EXCEPT_TOKOSW32_XVOID    __VREDIRECT_TOKOSW32
#define __VREDIRECT_EXCEPT_TOKOSW32_XVOID_   __VREDIRECT_TOKOSW32_
#define __VREDIRECT_EXCEPT_TOKOSW32_VOID     __VREDIRECT_TOKOSW32_VOID
#define __VREDIRECT_EXCEPT_TOKOSW32_VOID_    __VREDIRECT_TOKOSW32_VOID_
#define __XREDIRECT_EXCEPT_TOKOSW32          __XREDIRECT_TOKOSW32
#define __XREDIRECT_EXCEPT_TOKOSW32_         __XREDIRECT_TOKOSW32_
#define __XREDIRECT_EXCEPT_TOKOSW32_XVOID    __XREDIRECT_TOKOSW32
#define __XREDIRECT_EXCEPT_TOKOSW32_XVOID_   __XREDIRECT_TOKOSW32_
#define __XREDIRECT_EXCEPT_TOKOSW32_VOID     __XREDIRECT_TOKOSW32_VOID
#define __XREDIRECT_EXCEPT_TOKOSW32_VOID_    __XREDIRECT_TOKOSW32_VOID_
#define __REDIRECT_EXCEPT_TOKOS              __REDIRECT_TOKOS
#define __REDIRECT_EXCEPT_TODOS              __REDIRECT_TODOS
#define __REDIRECT_EXCEPT_TOKOS_             __REDIRECT_TOKOS_
#define __REDIRECT_EXCEPT_TODOS_             __REDIRECT_TODOS_
#define __REDIRECT_EXCEPT_TOKOS_XVOID        __REDIRECT_TOKOS
#define __REDIRECT_EXCEPT_TODOS_XVOID        __REDIRECT_TODOS
#define __REDIRECT_EXCEPT_TOKOS_XVOID_       __REDIRECT_TOKOS_
#define __REDIRECT_EXCEPT_TODOS_XVOID_       __REDIRECT_TODOS_
#define __REDIRECT_EXCEPT_TOKOS_VOID         __REDIRECT_TOKOS_VOID
#define __REDIRECT_EXCEPT_TODOS_VOID         __REDIRECT_TODOS_VOID
#define __REDIRECT_EXCEPT_TOKOS_VOID_        __REDIRECT_TOKOS_VOID_
#define __REDIRECT_EXCEPT_TODOS_VOID_        __REDIRECT_TODOS_VOID_
#define __VREDIRECT_EXCEPT_TOKOS             __VREDIRECT_TOKOS
#define __VREDIRECT_EXCEPT_TODOS             __VREDIRECT_TODOS
#define __VREDIRECT_EXCEPT_TOKOS_            __VREDIRECT_TOKOS_
#define __VREDIRECT_EXCEPT_TODOS_            __VREDIRECT_TODOS_
#define __VREDIRECT_EXCEPT_TOKOS_XVOID       __VREDIRECT_TOKOS
#define __VREDIRECT_EXCEPT_TODOS_XVOID       __VREDIRECT_TODOS
#define __VREDIRECT_EXCEPT_TOKOS_XVOID_      __VREDIRECT_TOKOS_
#define __VREDIRECT_EXCEPT_TODOS_XVOID_      __VREDIRECT_TODOS_
#define __VREDIRECT_EXCEPT_TOKOS_VOID        __VREDIRECT_TOKOS_VOID
#define __VREDIRECT_EXCEPT_TODOS_VOID        __VREDIRECT_TODOS_VOID
#define __VREDIRECT_EXCEPT_TOKOS_VOID_       __VREDIRECT_TOKOS_VOID_
#define __VREDIRECT_EXCEPT_TODOS_VOID_       __VREDIRECT_TODOS_VOID_
#define __XREDIRECT_EXCEPT_TOKOS             __XREDIRECT_TOKOS
#define __XREDIRECT_EXCEPT_TODOS             __XREDIRECT_TODOS
#define __XREDIRECT_EXCEPT_TOKOS_            __XREDIRECT_TOKOS_
#define __XREDIRECT_EXCEPT_TODOS_            __XREDIRECT_TODOS_
#define __XREDIRECT_EXCEPT_TOKOS_XVOID       __XREDIRECT_TOKOS
#define __XREDIRECT_EXCEPT_TODOS_XVOID       __XREDIRECT_TODOS
#define __XREDIRECT_EXCEPT_TOKOS_XVOID_      __XREDIRECT_TOKOS_
#define __XREDIRECT_EXCEPT_TODOS_XVOID_      __XREDIRECT_TODOS_
#define __XREDIRECT_EXCEPT_TOKOS_VOID        __XREDIRECT_TOKOS_VOID
#define __XREDIRECT_EXCEPT_TODOS_VOID        __XREDIRECT_TODOS_VOID
#define __XREDIRECT_EXCEPT_TOKOS_VOID_       __XREDIRECT_TOKOS_VOID_
#define __XREDIRECT_EXCEPT_TODOS_VOID_       __XREDIRECT_TODOS_VOID_
...
#define __XATTR_RETNONNULL          /* nothing */
#endif /* !__USE_EXCEPT */
...
#define __REDIRECT_UFSDPW32                __REDIRECT_TODOSDPW32_
#define __REDIRECT_UFSDPW16_VOID           __REDIRECT_TODOSDPW16_VOID_
#define __REDIRECT_UFSDPW32_VOID           __REDIRECT_TODOSDPW32_VOID_
#define __REDIRECT_UFSDPW16_NOTHROW        __REDIRECT_TODOSDPW16_NOTHROW_
#define __REDIRECT_UFSDPW32_NOTHROW        __REDIRECT_TODOSDPW32_NOTHROW_
#define __REDIRECT_UFSDPW16_VOID_NOTHROW   __REDIRECT_TODOSDPW16_VOID_NOTHROW_
#define __REDIRECT_UFSDPW32_VOID_NOTHROW   __REDIRECT_TODOSDPW32_VOID_NOTHROW_
#define __VREDIRECT_UFSDPW16               __VREDIRECT_TODOSDPW16_
#define __VREDIRECT_UFSDPW32               __VREDIRECT_TODOSDPW32_
#define __VREDIRECT_UFSDPW16_VOID          __VREDIRECT_TODOSDPW16_VOID_
#define __VREDIRECT_UFSDPW32_VOID          __VREDIRECT_TODOSDPW32_VOID_
#define __VREDIRECT_UFSDPW16_NOTHROW       __VREDIRECT_TODOSDPW16_NOTHROW_
#define __VREDIRECT_UFSDPW32_NOTHROW       __VREDIRECT_TODOSDPW32_NOTHROW_
#define __VREDIRECT_UFSDPW16_VOID_NOTHROW  __VREDIRECT_TODOSDPW16_VOID_NOTHROW_
#define __VREDIRECT_UFSDPW32_VOID_NOTHROW  __VREDIRECT_TODOSDPW32_VOID_NOTHROW_
#define __XREDIRECT_UFSDPW16               __XREDIRECT_TODOSDPW16_
#define __XREDIRECT_UFSDPW32               __XREDIRECT_TODOSDPW32_
#define __XREDIRECT_UFSDPW16_VOID          __XREDIRECT_TODOSDPW16_VOID_
#define __XREDIRECT_UFSDPW32_VOID          __XREDIRECT_TODOSDPW32_VOID_
#define __XREDIRECT_UFSDPW16_NOTHROW       __XREDIRECT_TODOSDPW16_NOTHROW_
#define __XREDIRECT_UFSDPW32_NOTHROW       __XREDIRECT_TODOSDPW32_NOTHROW_
#define __XREDIRECT_UFSDPW16_VOID_NOTHROW  __XREDIRECT_TODOSDPW16_VOID_NOTHROW_
#define __XREDIRECT_UFSDPW32_VOID_NOTHROW  __XREDIRECT_TODOSDPW32_VOID_NOTHROW_
#define __REDIRECT_EXCEPT_UFS              __REDIRECT_EXCEPT_TODOS
#define __REDIRECT_EXCEPT_UFS_             __REDIRECT_EXCEPT_TODOS_
#define __REDIRECT_EXCEPT_UFS_VOID         __REDIRECT_EXCEPT_TODOS_VOID
#define __REDIRECT_EXCEPT_UFS_VOID_        __REDIRECT_EXCEPT_TODOS_VOID_
#define __REDIRECT_EXCEPT_UFS_XVOID        __REDIRECT_EXCEPT_TODOS_XVOID
#define __REDIRECT_EXCEPT_UFS_XVOID_       __REDIRECT_EXCEPT_TODOS_XVOID_
#define __VREDIRECT_EXCEPT_UFS             __VREDIRECT_EXCEPT_TODOS
#define __VREDIRECT_EXCEPT_UFS_            __VREDIRECT_EXCEPT_TODOS_
#define __VREDIRECT_EXCEPT_UFS_VOID        __VREDIRECT_EXCEPT_TODOS_VOID
#define __VREDIRECT_EXCEPT_UFS_VOID_       __VREDIRECT_EXCEPT_TODOS_VOID_
#define __VREDIRECT_EXCEPT_UFS_XVOID       __VREDIRECT_EXCEPT_TODOS_XVOID
#define __VREDIRECT_EXCEPT_UFS_XVOID_      __VREDIRECT_EXCEPT_TODOS_XVOID_
#define __XREDIRECT_EXCEPT_UFS             __XREDIRECT_EXCEPT_TODOS
#define __XREDIRECT_EXCEPT_UFS_            __XREDIRECT_EXCEPT_TODOS_
#define __XREDIRECT_EXCEPT_UFS_VOID        __XREDIRECT_EXCEPT_TODOS_VOID
#define __XREDIRECT_EXCEPT_UFS_VOID_       __XREDIRECT_EXCEPT_TODOS_VOID_
#define __XREDIRECT_EXCEPT_UFS_XVOID       __XREDIRECT_EXCEPT_TODOS_XVOID
#define __XREDIRECT_EXCEPT_UFS_XVOID_      __XREDIRECT_EXCEPT_TODOS_XVOID_
#define __REDIRECT_EXCEPT_UFSW16           __REDIRECT_EXCEPT_TODOSW16_
#define __REDIRECT_EXCEPT_UFSW32           __REDIRECT_EXCEPT_TODOSW32_
#define __REDIRECT_EXCEPT_UFSW16_VOID      __REDIRECT_EXCEPT_TODOSW16_VOID_
#define __REDIRECT_EXCEPT_UFSW32_VOID      __REDIRECT_EXCEPT_TODOSW32_VOID_
#define __REDIRECT_EXCEPT_UFSW16_XVOID     __REDIRECT_EXCEPT_TODOSW16_XVOID_
#define __REDIRECT_EXCEPT_UFSW32_XVOID     __REDIRECT_EXCEPT_TODOSW32_XVOID_
#define __VREDIRECT_EXCEPT_UFSW16          __VREDIRECT_EXCEPT_TODOSW16_
#define __VREDIRECT_EXCEPT_UFSW32          __VREDIRECT_EXCEPT_TODOSW32_
#define __VREDIRECT_EXCEPT_UFSW16_VOID     __VREDIRECT_EXCEPT_TODOSW16_VOID_
#define __VREDIRECT_EXCEPT_UFSW32_VOID     __VREDIRECT_EXCEPT_TODOSW32_VOID_
#define __VREDIRECT_EXCEPT_UFSW16_XVOID    __VREDIRECT_EXCEPT_TODOSW16_XVOID_
#define __VREDIRECT_EXCEPT_UFSW32_XVOID    __VREDIRECT_EXCEPT_TODOSW32_XVOID_
#define __XREDIRECT_EXCEPT_UFSW16          __XREDIRECT_EXCEPT_TODOSW16_
#define __XREDIRECT_EXCEPT_UFSW32          __XREDIRECT_EXCEPT_TODOSW32_
#define __XREDIRECT_EXCEPT_UFSW16_VOID     __XREDIRECT_EXCEPT_TODOSW16_VOID_
#define __XREDIRECT_EXCEPT_UFSW32_VOID     __XREDIRECT_EXCEPT_TODOSW32_VOID_
#define __XREDIRECT_EXCEPT_UFSW16_XVOID    __XREDIRECT_EXCEPT_TODOSW16_XVOID_
#define __XREDIRECT_EXCEPT_UFSW32_XVOID    __XREDIRECT_EXCEPT_TODOSW32_XVOID_
#define __REDIRECT_EXCEPT_UFSDPW16         __REDIRECT_EXCEPT_TODOSDPW16_
#define __REDIRECT_EXCEPT_UFSDPW32         __REDIRECT_EXCEPT_TODOSDPW32_
#define __REDIRECT_EXCEPT_UFSDPW16_VOID    __REDIRECT_EXCEPT_TODOSDPW16_VOID_
#define __REDIRECT_EXCEPT_UFSDPW32_VOID    __REDIRECT_EXCEPT_TODOSDPW32_VOID_
#define __REDIRECT_EXCEPT_UFSDPW16_XVOID   __REDIRECT_EXCEPT_TODOSDPW16_XVOID_
#define __REDIRECT_EXCEPT_UFSDPW32_XVOID   __REDIRECT_EXCEPT_TODOSDPW32_XVOID_
#define __VREDIRECT_EXCEPT_UFSDPW16        __VREDIRECT_EXCEPT_TODOSDPW16_
#define __VREDIRECT_EXCEPT_UFSDPW32        __VREDIRECT_EXCEPT_TODOSDPW32_
#define __VREDIRECT_EXCEPT_UFSDPW16_VOID   __VREDIRECT_EXCEPT_TODOSDPW16_VOID_
#define __VREDIRECT_EXCEPT_UFSDPW32_VOID   __VREDIRECT_EXCEPT_TODOSDPW32_VOID_
#define __VREDIRECT_EXCEPT_UFSDPW16_XVOID  __VREDIRECT_EXCEPT_TODOSDPW16_XVOID_
#define __VREDIRECT_EXCEPT_UFSDPW32_XVOID  __VREDIRECT_EXCEPT_TODOSDPW32_XVOID_
#define __XREDIRECT_EXCEPT_UFSDPW16        __XREDIRECT_EXCEPT_TODOSDPW16_
#define __XREDIRECT_EXCEPT_UFSDPW32        __XREDIRECT_EXCEPT_TODOSDPW32_
#define __XREDIRECT_EXCEPT_UFSDPW16_VOID   __XREDIRECT_EXCEPT_TODOSDPW16_VOID_
#define __XREDIRECT_EXCEPT_UFSDPW32_VOID   __XREDIRECT_EXCEPT_TODOSDPW32_VOID_
#define __XREDIRECT_EXCEPT_UFSDPW16_XVOID  __XREDIRECT_EXCEPT_TODOSDPW16_XVOID_
#define __XREDIRECT_EXCEPT_UFSDPW32_XVOID  __XREDIRECT_EXCEPT_TODOSDPW32_XVOID_
#else
...
#define __REDIRECT_UFSDPW32                __REDIRECT_TOKOSW32_
#define __REDIRECT_UFSDPW16_VOID           __REDIRECT_TOKOSW16_VOID_
#define __REDIRECT_UFSDPW32_VOID           __REDIRECT_TOKOSW32_VOID_
#define __REDIRECT_UFSDPW16_NOTHROW        __REDIRECT_TOKOSW16_NOTHROW_
#define __REDIRECT_UFSDPW32_NOTHROW        __REDIRECT_TOKOSW32_NOTHROW_
#define __REDIRECT_UFSDPW16_VOID_NOTHROW   __REDIRECT_TOKOSW16_VOID_NOTHROW_
#define __REDIRECT_UFSDPW32_VOID_NOTHROW   __REDIRECT_TOKOSW32_VOID_NOTHROW_
#define __VREDIRECT_UFSDPW16               __VREDIRECT_TOKOSW16_
#define __VREDIRECT_UFSDPW32               __VREDIRECT_TOKOSW32_
#define __VREDIRECT_UFSDPW16_VOID          __VREDIRECT_TOKOSW16_VOID_
#define __VREDIRECT_UFSDPW32_VOID          __VREDIRECT_TOKOSW32_VOID_
#define __VREDIRECT_UFSDPW16_NOTHROW       __VREDIRECT_TOKOSW16_NOTHROW_
#define __VREDIRECT_UFSDPW32_NOTHROW       __VREDIRECT_TOKOSW32_NOTHROW_
#define __VREDIRECT_UFSDPW16_VOID_NOTHROW  __VREDIRECT_TOKOSW16_VOID_NOTHROW_
#define __VREDIRECT_UFSDPW32_VOID_NOTHROW  __VREDIRECT_TOKOSW32_VOID_NOTHROW_
#define __XREDIRECT_UFSDPW16               __XREDIRECT_TOKOSW16_
#define __XREDIRECT_UFSDPW32               __XREDIRECT_TOKOSW32_
#define __XREDIRECT_UFSDPW16_VOID          __XREDIRECT_TOKOSW16_VOID_
#define __XREDIRECT_UFSDPW32_VOID          __XREDIRECT_TOKOSW32_VOID_
#define __XREDIRECT_UFSDPW16_NOTHROW       __XREDIRECT_TOKOSW16_NOTHROW_
#define __XREDIRECT_UFSDPW32_NOTHROW       __XREDIRECT_TOKOSW32_NOTHROW_
#define __XREDIRECT_UFSDPW16_VOID_NOTHROW  __XREDIRECT_TOKOSW16_VOID_NOTHROW_
#define __XREDIRECT_UFSDPW32_VOID_NOTHROW  __XREDIRECT_TOKOSW32_VOID_NOTHROW_
#define __REDIRECT_EXCEPT_UFS              __REDIRECT_EXCEPT_TOKOS
#define __REDIRECT_EXCEPT_UFS_             __REDIRECT_EXCEPT_TOKOS_
#define __REDIRECT_EXCEPT_UFS_VOID         __REDIRECT_EXCEPT_TOKOS_VOID
#define __REDIRECT_EXCEPT_UFS_VOID_        __REDIRECT_EXCEPT_TOKOS_VOID_
#define __REDIRECT_EXCEPT_UFS_XVOID        __REDIRECT_EXCEPT_TOKOS_XVOID
#define __REDIRECT_EXCEPT_UFS_XVOID_       __REDIRECT_EXCEPT_TOKOS_XVOID_
#define __VREDIRECT_EXCEPT_UFS             __VREDIRECT_EXCEPT_TOKOS
#define __VREDIRECT_EXCEPT_UFS_            __VREDIRECT_EXCEPT_TOKOS_
#define __VREDIRECT_EXCEPT_UFS_VOID        __VREDIRECT_EXCEPT_TOKOS_VOID
#define __VREDIRECT_EXCEPT_UFS_VOID_       __VREDIRECT_EXCEPT_TOKOS_VOID_
#define __VREDIRECT_EXCEPT_UFS_XVOID       __VREDIRECT_EXCEPT_TOKOS_XVOID
#define __VREDIRECT_EXCEPT_UFS_XVOID_      __VREDIRECT_EXCEPT_TOKOS_XVOID_
#define __XREDIRECT_EXCEPT_UFS             __XREDIRECT_EXCEPT_TOKOS
#define __XREDIRECT_EXCEPT_UFS_            __XREDIRECT_EXCEPT_TOKOS_
#define __XREDIRECT_EXCEPT_UFS_VOID        __XREDIRECT_EXCEPT_TOKOS_VOID
#define __XREDIRECT_EXCEPT_UFS_VOID_       __XREDIRECT_EXCEPT_TOKOS_VOID_
#define __XREDIRECT_EXCEPT_UFS_XVOID       __XREDIRECT_EXCEPT_TOKOS_XVOID
#define __XREDIRECT_EXCEPT_UFS_XVOID_      __XREDIRECT_EXCEPT_TOKOS_XVOID_
#define __REDIRECT_EXCEPT_UFSW16           __REDIRECT_EXCEPT_TOKOSW16_
#define __REDIRECT_EXCEPT_UFSW32           __REDIRECT_EXCEPT_TOKOSW32_
#define __REDIRECT_EXCEPT_UFSW16_VOID      __REDIRECT_EXCEPT_TOKOSW16_VOID_
#define __REDIRECT_EXCEPT_UFSW32_VOID      __REDIRECT_EXCEPT_TOKOSW32_VOID_
#define __REDIRECT_EXCEPT_UFSW16_XVOID     __REDIRECT_EXCEPT_TOKOSW16_XVOID_
#define __REDIRECT_EXCEPT_UFSW32_XVOID     __REDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __VREDIRECT_EXCEPT_UFSW16          __VREDIRECT_EXCEPT_TOKOSW16_
#define __VREDIRECT_EXCEPT_UFSW32          __VREDIRECT_EXCEPT_TOKOSW32_
#define __VREDIRECT_EXCEPT_UFSW16_VOID     __VREDIRECT_EXCEPT_TOKOSW16_VOID_
#define __VREDIRECT_EXCEPT_UFSW32_VOID     __VREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __VREDIRECT_EXCEPT_UFSW16_XVOID    __VREDIRECT_EXCEPT_TOKOSW16_XVOID_
#define __VREDIRECT_EXCEPT_UFSW32_XVOID    __VREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __XREDIRECT_EXCEPT_UFSW16          __XREDIRECT_EXCEPT_TOKOSW16_
#define __XREDIRECT_EXCEPT_UFSW32          __XREDIRECT_EXCEPT_TOKOSW32_
#define __XREDIRECT_EXCEPT_UFSW16_VOID     __XREDIRECT_EXCEPT_TOKOSW16_VOID_
#define __XREDIRECT_EXCEPT_UFSW32_VOID     __XREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __XREDIRECT_EXCEPT_UFSW16_XVOID    __XREDIRECT_EXCEPT_TOKOSW16_XVOID_
#define __XREDIRECT_EXCEPT_UFSW32_XVOID    __XREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __REDIRECT_EXCEPT_UFSDPW16         __REDIRECT_EXCEPT_TOKOSW16_
#define __REDIRECT_EXCEPT_UFSDPW32         __REDIRECT_EXCEPT_TOKOSW32_
#define __REDIRECT_EXCEPT_UFSDPW16_VOID    __REDIRECT_EXCEPT_TOKOSW16_VOID_
#define __REDIRECT_EXCEPT_UFSDPW32_VOID    __REDIRECT_EXCEPT_TOKOSW32_VOID_
#define __REDIRECT_EXCEPT_UFSDPW16_XVOID   __REDIRECT_EXCEPT_TOKOSW16_XVOID_
#define __REDIRECT_EXCEPT_UFSDPW32_XVOID   __REDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __VREDIRECT_EXCEPT_UFSDPW16        __VREDIRECT_EXCEPT_TOKOSW16_
#define __VREDIRECT_EXCEPT_UFSDPW32        __VREDIRECT_EXCEPT_TOKOSW32_
#define __VREDIRECT_EXCEPT_UFSDPW16_VOID   __VREDIRECT_EXCEPT_TOKOSW16_VOID_
#define __VREDIRECT_EXCEPT_UFSDPW32_VOID   __VREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __VREDIRECT_EXCEPT_UFSDPW16_XVOID  __VREDIRECT_EXCEPT_TOKOSW16_XVOID_
#define __VREDIRECT_EXCEPT_UFSDPW32_XVOID  __VREDIRECT_EXCEPT_TOKOSW32_XVOID_
#define __XREDIRECT_EXCEPT_UFSDPW16        __XREDIRECT_EXCEPT_TOKOSW16_
#define __XREDIRECT_EXCEPT_UFSDPW32        __XREDIRECT_EXCEPT_TOKOSW32_
#define __XREDIRECT_EXCEPT_UFSDPW16_VOID   __XREDIRECT_EXCEPT_TOKOSW16_VOID_
#define __XREDIRECT_EXCEPT_UFSDPW32_VOID   __XREDIRECT_EXCEPT_TOKOSW32_VOID_
#define __XREDIRECT_EXCEPT_UFSDPW16_XVOID  __XREDIRECT_EXCEPT_TOKOSW16_XVOID_
#define __XREDIRECT_EXCEPT_UFSDPW32_XVOID  __XREDIRECT_EXCEPT_TOKOSW32_XVOID_
#endif
...
#ifdef __USE_EXCEPT
#define __SYMNAME_EXCEPT_DOSPREFIX(x) __SYMNAME_EXCEPT_DOS(_##x)
...
#define __REDIRECT_EXCEPT_DPB_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),args)
...
#define __VREDIRECT_EXCEPT_DPB_XVOID(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start) __VREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),__SYMNAME_EXCEPT_DOSPREFIX(vasmnamef),args,before_va_start)
...
#define __XREDIRECT_EXCEPT_DPB_XVOID(decl,attr,Treturn,cc,name,param,code)                           __XREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),code)
#else /* __USE_EXCEPT */
...
#define __XREDIRECT_DPB_VOID_NOTHROW(decl,attr,cc,name,param,code)                                  __XREDIRECT_VOID_NOTHROW(decl,attr,cc,_##name,param,__SYMNAME_DOSPREFIX(name),code)
#ifdef __USE_EXCEPT
#define __SYMNAME_EXCEPT_DOSPREFIX  __SYMNAME_EXCEPT_KOS
#define __REDIRECT_EXCEPT_DPB(decl,attr,Treturn,cc,name,param,args)                                  __REDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_DPB_VOID(decl,attr,cc,name,param,args)                                     __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_DPB_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),args)
#define __VREDIRECT_EXCEPT_DPB(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)       __VREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_DOSPREFIX(name),__SYMNAME_EXCEPT_DOSPREFIX(vasmnamef),args,before_va_start)
...
#ifdef __USE_EXCEPT
#define __SYMNAME_EXCEPT_UFSDOSPREFIX(x)   __SYMNAME_EXCEPT_DOS(_##x)
#define __REDIRECT_EXCEPT_UFSDPA(decl,attr,Treturn,cc,name,param,args)                                  __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_UFSDPA_VOID(decl,attr,cc,name,param,args)                                     __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_UFSDPA_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __VREDIRECT_EXCEPT_UFSDPA(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)       __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPA_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)          __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPA_XVOID(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start) __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_UFSDPA(decl,attr,Treturn,cc,name,param,code)                                 __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#define __XREDIRECT_EXCEPT_UFSDPA_VOID(decl,attr,cc,name,param,code)                                    __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#define __XREDIRECT_EXCEPT_UFSDPA_XVOID(decl,attr,Treturn,cc,name,param,code)                           __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#else /* __USE_EXCEPT */
...
#ifdef __USE_EXCEPT
#define __REDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,args)                                  __REDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,args)                                     __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __VREDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)       __VREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)          __VREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start) __VREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,code)                                 __XREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#define __XREDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,code)                                    __XREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#define __XREDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,code)                           __XREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#else /* __USE_EXCEPT */
...
#define __REDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,args)                                  __REDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,args)                                     __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __REDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),args)
#define __VREDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)       __VREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)          __VREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start) __VREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),__SYMNAME_EXCEPT_UFSDOSPREFIX(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,code)                                 __XREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#define __XREDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,code)                                    __XREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#define __XREDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,code)                           __XREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_UFSDOSPREFIX(name),code)
#else /* __USE_EXCEPT */
...
#ifdef __USE_EXCEPT
#define __SYMNAME_EXCEPT_UFSDOSPREFIX __SYMNAME_EXCEPT_KOS
#define __REDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,args)                                  __REDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),args)
#define __REDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,args)                                     __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),args)
#define __REDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),args)
#define __VREDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)       __VREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),__SYMNAME_EXCEPT_KOS(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)          __VREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),__SYMNAME_EXCEPT_KOS(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start) __VREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),__SYMNAME_EXCEPT_KOS(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_UFSDPB(decl,attr,Treturn,cc,name,param,code)                                 __XREDIRECT(decl,attr,Treturn,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),code)
#define __XREDIRECT_EXCEPT_UFSDPB_VOID(decl,attr,cc,name,param,code)                                    __XREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),code)
#define __XREDIRECT_EXCEPT_UFSDPB_XVOID(decl,attr,Treturn,cc,name,param,code)                           __XREDIRECT_VOID(decl,attr,cc,_##name,param,__SYMNAME_EXCEPT_KOS(name),code)
#else /* __USE_EXCEPT */
...
#ifdef __USE_EXCEPT
#define __REDIRECT_EXCEPT_UFSDPA(decl,attr,Treturn,cc,name,param,args)                                  __REDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOS(name),args)
#define __REDIRECT_EXCEPT_UFSDPA_VOID(decl,attr,cc,name,param,args)                                     __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOS(name),args)
#define __REDIRECT_EXCEPT_UFSDPA_XVOID(decl,attr,Treturn,cc,name,param,args)                            __REDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOS(name),args)
#define __VREDIRECT_EXCEPT_UFSDPA(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start)       __VREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOS(name),__SYMNAME_EXCEPT_KOS(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPA_VOID(decl,attr,cc,name,param,vasmnamef,args,before_va_start)          __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOS(name),__SYMNAME_EXCEPT_KOS(vasmnamef),args,before_va_start)
#define __VREDIRECT_EXCEPT_UFSDPA_XVOID(decl,attr,Treturn,cc,name,param,vasmnamef,args,before_va_start) __VREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOS(name),__SYMNAME_EXCEPT_KOS(vasmnamef),args,before_va_start)
#define __XREDIRECT_EXCEPT_UFSDPA(decl,attr,Treturn,cc,name,param,code)                                 __XREDIRECT(decl,attr,Treturn,cc,name,param,__SYMNAME_EXCEPT_KOS(name),code)
#define __XREDIRECT_EXCEPT_UFSDPA_VOID(decl,attr,cc,name,param,code)                                    __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOS(name),code)
#define __XREDIRECT_EXCEPT_UFSDPA_XVOID(decl,attr,Treturn,cc,name,param,code)                           __XREDIRECT_VOID(decl,attr,cc,name,param,__SYMNAME_EXCEPT_KOS(name),code)
#else /* __USE_EXCEPT */
