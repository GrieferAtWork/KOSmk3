...
typedef int                     __fd_t;
#if !defined(__USE_KOS) || defined(__USE_KOS_DEPRECATED)
typedef int                     __atflag_t;
#else
typedef unsigned int            __atflag_t;
#endif
...
#undef __ARCH_WIDE_64BIT_SYSCALL
#ifndef __x86_64__
#define __ARCH_WIDE_64BIT_SYSCALL 1
#endif
...
#include <features.h>
   ...
   (__KOS_VERSION__ < 300 && __SIZEOF_SYSCALL_LONG__ >= 8)
 ...
 *   - __ASMNAME("lseek64"): A libc function using __off64_t as argument.
