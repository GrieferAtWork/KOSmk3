...
LOCAL bool KCALL atomic_rwptr_tryread(atomic_rwptr_t *__restrict self);
LOCAL bool KCALL atomic_rwptr_trywrite(atomic_rwptr_t *__restrict self);
LOCAL void KCALL atomic_rwptr_read(atomic_rwptr_t *__restrict self);
LOCAL void KCALL atomic_rwptr_write(atomic_rwptr_t *__restrict self);

/* Try to upgrade a read-lock to a write-lock. Return `FALSE' upon failure. */
LOCAL bool KCALL atomic_rwptr_tryupgrade(atomic_rwptr_t *__restrict self);
...
LOCAL bool KCALL atomic_rwptr_upgrade(atomic_rwptr_t *__restrict self);
LOCAL void KCALL atomic_rwptr_downgrade(atomic_rwptr_t *__restrict self);

/* End reading/writing/either. */
LOCAL void KCALL atomic_rwptr_endwrite(atomic_rwptr_t *__restrict self);
LOCAL void KCALL atomic_rwptr_endread(atomic_rwptr_t *__restrict self);
LOCAL void KCALL atomic_rwptr_end(atomic_rwptr_t *__restrict self);
