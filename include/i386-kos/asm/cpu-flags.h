...
#define IA32_MISC_ENABLE_FAST_STRING         (__UINT64_C(1) << 0)
#define IA32_MISC_ENABLE_TCC                 (__UINT64_C(1) << 1)
#define IA32_MISC_ENABLE_EMON                (__UINT64_C(1) << 7)
#define IA32_MISC_ENABLE_BTS_UNAVAIL         (__UINT64_C(1) << 11)
#define IA32_MISC_ENABLE_PEBS_UNAVAIL        (__UINT64_C(1) << 12)
#define IA32_MISC_ENABLE_ENHANCED_SPEEDSTEP  (__UINT64_C(1) << 16)
#define IA32_MISC_ENABLE_MWAIT               (__UINT64_C(1) << 18)
#define IA32_MISC_ENABLE_LIMIT_CPUID         (__UINT64_C(1) << 22)
#define IA32_MISC_ENABLE_XTPR_DISABLE        (__UINT64_C(1) << 23)
...
#define IA32_MISC_ENABLE_SUPPRESS_LOCK       (__UINT64_C(1) << 8)
#define IA32_MISC_ENABLE_PREFETCH_DISABLE    (__UINT64_C(1) << 9)
#define IA32_MISC_ENABLE_FERR                (__UINT64_C(1) << 10)
#define IA32_MISC_ENABLE_FERR_MULTIPLEX      (__UINT64_C(1) << 10)
#define IA32_MISC_ENABLE_TM2                 (__UINT64_C(1) << 13)
#define IA32_MISC_ENABLE_ADJ_PREF_DISABLE    (__UINT64_C(1) << 19)
#define IA32_MISC_ENABLE_SPEEDSTEP_LOCK      (__UINT64_C(1) << 20)
#define IA32_MISC_ENABLE_L1D_CONTEXT         (__UINT64_C(1) << 24)
#define IA32_MISC_ENABLE_DCU_PREF_DISABLE    (__UINT64_C(1) << 37)
#define IA32_MISC_ENABLE_TURBO_DISABLE       (__UINT64_C(1) << 38)
#define IA32_MISC_ENABLE_IP_PREF_DISABLE     (__UINT64_C(1) << 39)
...
#define CPUID_1D_PSE             0x00000008 /* [bit(EDX:3)] Page Size Extension. */
...
#define CPUID_80000001D_PSE           0x00000008 /* [bit(3)] Page Size Extension. */
...
#define CPUID_80000001D_PSE36         0x00020000 /* [bit(17)] 36-bit page size extension. */
