...
#ifdef __USE_ATFILE
#ifdef __USE_FILE_OFFSET64
__REDIRECT_VOID(__LIBC,__PORT_KOSONLY __NONNULL((2,3)),__LIBCCALL,Xfstatat,(__fd_t __fd, char const *__restrict __file, struct stat *__restrict __buf, int __flags),Xkfstatat64,(__fd,__file,__buf,__flags))
#else
__REDIRECT_VOID(__LIBC,__PORT_KOSONLY __NONNULL((2,3)),__LIBCCALL,Xfstatat,(__fd_t __fd, char const *__restrict __file, struct stat *__restrict __buf, int __flags),Xkfstatat,(__fd,__file,__buf,__flags))
#endif
#ifdef __USE_LARGEFILE64
...
__LIBC __PORT_KOSONLY __NONNULL((1)) void (__LIBCCALL Xchmod)(char const *__file, int __mode);
#ifdef __USE_MISC
...
__LIBC __PORT_KOSONLY __NONNULL((2)) void (__LIBCCALL Xfmkdirat)(__fd_t __dfd, char const *__path, __mode_t __mode, int __flags);
__LIBC __PORT_KOSONLY __NONNULL((2)) void (__LIBCCALL Xfmknodat)(__fd_t __dfd, char const *__path, __mode_t __mode, __dev_t __dev, int __flags);
#endif

__LIBC __PORT_KOSONLY __NONNULL((1)) void (__LIBCCALL Xmkfifo)(char const *__path, __mode_t __mode);
#ifdef __USE_ATFILE
__LIBC __PORT_KOSONLY __NONNULL((2)) void (__LIBCCALL Xfchmodat)(__fd_t __dfd, char const *__file, __mode_t __mode, int __flags);
...
#ifdef __USE_ATFILE
__REDIRECT_TM64_VOID(__LIBC,__PORT_KOSONLY __NONNULL((2)),__LIBCCALL,Xutimensat,(__fd_t __dfd, char const *__path, struct timespec const __times[2], int __flags),(__dfd,__path,__times,__flags))
#ifdef __USE_TIME64
__LIBC __PORT_KOSONLY __NONNULL((2)) void (__LIBCCALL Xutimensat64)(__fd_t __dfd, char const *__path, struct __timespec64 const __times[2], int __flags);
#endif /* __USE_TIME64 */
#endif /* __USE_ATFILE */
