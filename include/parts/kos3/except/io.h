...
__LIBC __PORT_KOSONLY __WUNUSED int (__LIBCCALL Xdup)(__fd_t __fd);
#endif /* !__Xdup_defined */
#ifndef __Xdup2_defined
#define __Xdup2_defined 1
__LIBC __PORT_KOSONLY int (__LIBCCALL Xdup2)(int __ofd, int __nfd);
...
__REDIRECT(__LIBC,__PORT_KOSONLY __WUNUSED __NONNULL((1)),int,__LIBCCALL,_Xcreat,(char const *__file, int __pmode),Xcreat,(__file,__pmode))
__REDIRECT_VOID(__LIBC,__PORT_KOSONLY __NONNULL((1)),__LIBCCALL,_Xchmod,(char const *__file, int __mode),Xchmod,(__file,__mode))
...
__REDIRECT(__LIBC,__PORT_KOSONLY,int,__LIBCCALL,_Xdup,(__fd_t __fd),Xdup,(__fd))
__REDIRECT(__LIBC,__PORT_KOSONLY,int,__LIBCCALL,_Xdup2,(int __ofd, int __nfd),Xdup2,(__ofd,__nfd))
...
__VREDIRECT(__LIBC,__PORT_KOSONLY __WUNUSED,int,__ATTR_CDECL,_Xopen,(char const *__file, int __oflag, ...),Xopen,TODO,(__file,__oflag),__oflag)
