 ...
 * >> size_t reqlen;
 * >> reqlen = format_wprintf(&format_wwidth,NULL,L"foo = %d",42);
 * >> printf("reqlen = %Iu\n",reqlen); // `reqlen = 8' */
__REDIRECT(__LIBC,,__ssize_t,__LIBCCALL,format_wwidth,
          (wchar_t const *__restrict __data, __size_t __datalen, void *__closure),
