...
__VREDIRECT_EXCEPT_UFSDPW16(__LIBC,__PORT_DOSONLY __WUNUSED_SUGGESTED __NONNULL((1)),int,__ATTR_CDECL,_w16open,(char16_t const *__restrict __file, int __oflag, ...),wsopen,TODO,(__file,__oflag),__oflag)
__VREDIRECT_EXCEPT_UFSW32  (__LIBC,__PORT_DOSONLY __WUNUSED_SUGGESTED __NONNULL((1)),int,__ATTR_CDECL,_w32open,(char32_t const *__restrict __file, int __oflag, ...),wsopen,TODO,(__file,__oflag),__oflag)
__VREDIRECT_UFSDPW16(__LIBC,__PORT_DOSONLY __WUNUSED_SUGGESTED __NONNULL((1)),int,__ATTR_CDECL,_w16sopen,(char16_t const *__restrict __file, int __oflag, int __sflag, ...),wsopen,TODO,(__file,__oflag,__sflag),__sflag)
__VREDIRECT_UFSW32  (__LIBC,__PORT_DOSONLY __WUNUSED_SUGGESTED __NONNULL((1)),int,__ATTR_CDECL,_w32sopen,(char32_t const *__restrict __file, int __oflag, int __sflag, ...),wsopen,TODO,(__file,__oflag,__sflag),__sflag)
__REDIRECT_EXCEPT_UFSDPW16(__LIBC,__WUNUSED __PORT_DOSONLY __NONNULL((1)),int,__LIBCCALL,_w16creat,(char16_t const *__restrict __file, int __pmode),wcreat,(__file,__pmode))
__REDIRECT_EXCEPT_UFSW32  (__LIBC,__WUNUSED __PORT_DOSONLY __NONNULL((1)),int,__LIBCCALL,_w32creat,(char32_t const *__restrict __file, int __pmode),wcreat,(__file,__pmode))
__REDIRECT_UFSDPW16(__LIBC,__PORT_DOSONLY __WUNUSED_SUGGESTED __NONNULL((1,2)),errno_t,__LIBCCALL,_w16sopen_s,(int *__restrict __fd, char16_t const *__restrict __file, int __oflag, int __sflag, int __pflags),wsopen_s,(__fd,__file,__oflag,__sflag,__pflags))
__REDIRECT_UFSW32  (__LIBC,__PORT_DOSONLY __WUNUSED_SUGGESTED __NONNULL((1,2)),errno_t,__LIBCCALL,_w32sopen_s,(int *__restrict __fd, char32_t const *__restrict __file, int __oflag, int __sflag, int __pflags),wsopen_s,(__fd,__file,__oflag,__sflag,__pflags))
...
__REDIRECT_EXCEPT_UFSDPW16_XVOID(__LIBC,__PORT_DOSONLY __NONNULL((1)),int,__LIBCCALL,_w16chmod,(char16_t const *__restrict __file, int __mode),wchmod,(__file,__mode))
__REDIRECT_EXCEPT_UFSW32_XVOID  (__LIBC,__PORT_DOSONLY __NONNULL((1)),int,__LIBCCALL,_w32chmod,(char32_t const *__restrict __file, int __mode),wchmod,(__file,__mode))
