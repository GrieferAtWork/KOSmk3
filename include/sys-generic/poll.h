...
#else /* __GLC_COMPAT__ */
__REDIRECT_EXCEPT_TM64(__LIBC,,__EXCEPT_SELECT(unsigned int,int),__LIBCCALL,ppoll,
                      (struct pollfd *__fds, nfds_t __nfds, struct timespec const *__timeout, __sigset_t const *__ss),
                      (__fds,__nfds,__timeout,__ss))
#ifdef __USE_TIME64
__REDIRECT_EXCEPT(__LIBC,,__EXCEPT_SELECT(unsigned int,int),__LIBCCALL,ppoll64,
                 (struct pollfd *__fds, nfds_t __nfds, struct __timespec64 const *__timeout, __sigset_t const *__ss),
                 (__fds,__nfds,__timeout,__ss))
#endif /* __USE_TIME64 */
...
#ifdef __USE_EXCEPT
#include <parts/kos3/except/sys/poll.h>
#endif
