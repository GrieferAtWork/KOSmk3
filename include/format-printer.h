...
#if (!defined(__CRT_KOS) || defined(__ANY_COMPAT__)) && \
...
__FORMAT_PRINTER_DECL __ATTR_LIBC_PRINTF(3,0) __NONNULL((1,3,4))
...
/* Additional format-printer functions that support custom
 * locales, as well as DOS's positional-argument extension. */
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF(3,5) __NONNULL((1,3)) __ssize_t (__ATTR_CDECL format_printf_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF(3,0) __NONNULL((1,3,5)) __ssize_t (__LIBCCALL format_vprintf_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, __builtin_va_list __args);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,4) __NONNULL((1,3)) __ssize_t (__ATTR_CDECL format_printf_p)(pformatprinter __printer, void *__closure, char const *__restrict __format, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,0) __NONNULL((1,3,4)) __ssize_t (__LIBCCALL format_vprintf_p)(pformatprinter __printer, void *__closure, char const *__restrict __format, __builtin_va_list __args);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,5) __NONNULL((1,3)) __ssize_t (__ATTR_CDECL format_printf_p_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,0) __NONNULL((1,3,5)) __ssize_t (__LIBCCALL format_vprintf_p_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, __builtin_va_list __args);
...
__LIBC __PORT_KOSONLY __ATTR_LIBC_SCANF(4,5) __NONNULL((1,2,4))
...
__LIBC __PORT_KOSONLY __ATTR_LIBC_SCANF(4,0) __NONNULL((1,2,4))
__ssize_t (__LIBCCALL format_vscanf)(pformatgetc __pgetc, pformatungetc __pungetc,
                                     void *__closure, char const *__restrict __format,
                                     __builtin_va_list __args);
#if __KOS_VERSION__ >= 300 && defined(__CRT_KOS) && !defined(__KERNEL__)
/* Additional format-scanner functions that support custom locales. */
__LIBC __PORT_KOSONLY __ATTR_LIBC_SCANF(4,6) __NONNULL((1,2,4))
__ssize_t (__ATTR_CDECL format_scanf_l)(pformatgetc __pgetc, pformatungetc __pungetc,
                                        void *__closure, char const *__restrict __format,
                                        __locale_t __locale, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_SCANF(4,0) __NONNULL((1,2,4))
__ssize_t (__LIBCCALL format_vscanf_l)(pformatgetc __pgetc, pformatungetc __pungetc,
                                       void *__closure, char const *__restrict __format,
 ...
 *         - Short attributes names alias the following longer names also recognized:
 *           - `"Y"'        --> `"year"'
 *           - `"M"'        --> `"month"'
 *           - `"WD"'       --> `"wday"'
 *           - `"MD"'|`"D"' --> `"mday"'
...
__ssize_t (__LIBCCALL format_strftime)(pformatprinter __printer, void *__closure,
                                       char const *__restrict __format,
                                       struct __NAMESPACE_STD_SYM tm const *__restrict __tm);
#if __KOS_VERSION__ >= 300
/* Additional format-time function that support custom locales. */
__LIBC __PORT_KOSONLY __ATTR_LIBC_STRFTIME(3,4) __NONNULL((1,4))
__ssize_t (__LIBCCALL format_strftime_l)(pformatprinter __printer, void *__closure,
                                         char const *__restrict __format,
                                         struct __NAMESPACE_STD_SYM tm const *__restrict __tm,
                                         __locale_t __locale);
...
#if __KOS_VERSION__ >= 300 && defined(__CRT_KOS) && !defined(__KERNEL__)
/* Additional format-quote function that support custom locales. */
__LIBC __PORT_KOSONLY __NONNULL((1,3)) __ssize_t
(__LIBCCALL format_quote_l)(pformatprinter __printer, void *__closure,
                            char const *__restrict __text, __size_t __textlen,
                            __UINT32_TYPE__ __flags, __locale_t __locale);
#endif /* __KOS_VERSION__ >= 300 && __CRT_KOS && !__KERNEL__ */
#endif /* __CC__ */
...
#if __KOS_VERSION__ >= 300 && defined(__CRT_KOS) && !defined(__KERNEL__)
/* Additional format-hexdump function that support custom locales. */
__LIBC __PORT_KOSONLY __NONNULL((1,3)) __ssize_t
(__LIBCCALL format_hexdump_l)(pformatprinter __printer, void *__closure,
                              void const *__restrict __data, __size_t __size,
                              __size_t __linesize, __UINT32_TYPE__ __flags,
                              __locale_t __locale);
#endif /* __KOS_VERSION__ >= 300 && __CRT_KOS && !__KERNEL__ */
...
#ifndef __stringprinter_defined
#define __stringprinter_defined 1
struct stringprinter { __DEFINE_STRINGPRINTER(char) };
#endif /* !__stringprinter_defined */
...
__REDIRECT_EXCEPT_XVOID(__FORMAT_PRINTER_DECL,__NONNULL((1)),int,__LIBCCALL,stringprinter_init,(struct stringprinter *__restrict __self, __size_t __hint),(__self,__hint))
...
__REDIRECT_EXCEPT(__FORMAT_PRINTER_DECL,,__ssize_t,__LIBCCALL,stringprinter_print,(char const *__restrict __data, __size_t __datalen, void *__closure),(__data,__datalen,__closure))
#ifdef __USE_EXCEPT
__LIBC __PORT_KOSONLY __NONNULL((1)) void (__LIBCCALL Xstringprinter_init)(struct stringprinter *__restrict __self, __size_t __hint);
__LIBC __PORT_KOSONLY __ssize_t (__LIBCCALL Xstringprinter_print)(char const *__restrict __data, __size_t __datalen, void *__closure);
#endif /* __USE_EXCEPT */
#endif
 ...
 */
#ifndef __buffer_defined
#define __buffer_defined 1
...
#define __DEFINE_BUFFER(Tprinter,T) \
    ...
    void             *__padding;   /* ... (Forward-compatibility & align to `8*sizeof(void *)', which is quite the pretty number) */
#endif
struct buffer { __DEFINE_BUFFER(pformatprinter,char) };
#undef __DEFINE_BUFFER
#endif /* !__buffer_defined */

/* Static initializer for buffers. */
#ifndef BUFFER_INIT
#define BUFFER_INIT(printer,closure) {printer,closure,{0},__NULLPTR,__NULLPTR,__NULLPTR,__NULLPTR}
#endif
...
#if __KOS_VERSION__ >= 300
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF(3,5) __NONNULL((1,3)) __ssize_t (__ATTR_CDECL format_bprintf_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF(3,0) __NONNULL((1,3)) __ssize_t (__LIBCCALL format_vbprintf_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, __builtin_va_list __args);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,4) __NONNULL((1,3)) __ssize_t (__ATTR_CDECL format_bprintf_p)(pformatprinter __printer, void *__closure, char const *__restrict __format, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,0) __NONNULL((1,3)) __ssize_t (__LIBCCALL format_vbprintf_p)(pformatprinter __printer, void *__closure, char const *__restrict __format, __builtin_va_list __args);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,5) __NONNULL((1,3)) __ssize_t (__ATTR_CDECL format_bprintf_p_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, ...);
__LIBC __PORT_KOSONLY __ATTR_LIBC_PRINTF_P(3,0) __NONNULL((1,3)) __ssize_t (__LIBCCALL format_vbprintf_p_l)(pformatprinter __printer, void *__closure, char const *__restrict __format, __locale_t __locale, __builtin_va_list __args);
#endif
#endif /* !__KERNEL__ */
