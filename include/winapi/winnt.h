...
__LIBC __UINT8_TYPE__ (__cdecl _rotl8)(__UINT8_TYPE__ Value, __UINT8_TYPE__ Shift);
__LIBC __UINT8_TYPE__ (__cdecl _rotr8)(__UINT8_TYPE__ Value, __UINT8_TYPE__ Shift);
__LIBC __UINT16_TYPE__ (__cdecl _rotl16)(__UINT16_TYPE__ Value, __UINT8_TYPE__ Shift);
__LIBC __UINT16_TYPE__ (__cdecl _rotr16)(__UINT16_TYPE__ Value, __UINT8_TYPE__ Shift);
#endif /* __x86_64__ */
...
#undef _rotl64
#undef _rotr64
__LIBC __UINT32_TYPE__ (__cdecl _rotl)(__UINT32_TYPE__ Value, int Shift);
__LIBC __UINT32_TYPE__ (__cdecl _rotr)(__UINT32_TYPE__ Value, int Shift);
__LIBC __UINT64_TYPE__ (__cdecl _rotl64)(__UINT64_TYPE__ Value, int Shift);
__LIBC __UINT64_TYPE__ (__cdecl _rotr64)(__UINT64_TYPE__ Value, int Shift);
...
__CRT_INLINE BOOLEAN (_bittest)(LONG const *Base, LONG Offset) {
 ...
 __asm__ __volatile__("btl %2,%1\n\tsbbl %0,%0 "
                      : "=r" (old)
                      , "=m" ((*(volatile __LONG32_TYPE__ *) Base))
                      : "Ir" (Offset));
...
__CRT_INLINE BOOLEAN (_BitScanForward)(DWORD *Index, DWORD Mask) {
 __asm__ __volatile__("bsfl %1,%0"
                      : "=r" (Mask)
                      , "=m" ((*(volatile __LONG32_TYPE__ *)Index)));
 return Mask!=0;
}
...
__CRT_INLINE PVOID GetFiberData(VOID) { return *(PVOID *)GetCurrentFiber(); }
#endif /* !__CRT__NO_INLINE */
#endif
